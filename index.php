...
$mass = [
    [
        "name" => "Военнослужащий",
        "dateStart" => "сентябрь 2017",
        "dateEnd" => "апрель 2021",
        "description" => "Служил военнослужащим по контракту. Занимал военнское звание сержант, в мои обязаности входили строить маршруты
        для автомобильных колонн, которые перевозили грузы для материального обеспечения округа.",
    ],
    [
        "name" => "Специалист 3 категории",
        "dateStart" => "март 2023",
        "dateEnd" => "По настоящее время",
        "description" => "Работа. в службе поддержки по сложным вопрсам электронного документаоборота. В мои обязаности входят быстрая и качественная 
        поддержка клиентов по возникшим вопросам электронного документаоборота.",
    ],
];
